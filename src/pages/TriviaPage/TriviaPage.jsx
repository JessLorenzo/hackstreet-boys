			...
			<div className="main">
				...
				<span>
					<p className="main__text">
						Answer 3 questions correctly to start you win streak. Didn’t make it to the next round? No
						problem! You can upgrade to Premium to continue or return in 24 hours to try again.
					</p>
				</span>
